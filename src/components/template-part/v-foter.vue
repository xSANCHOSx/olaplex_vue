      ...
      <div class="row">
        ...
        <div class="col-md-9 col-xs-12">
          <nav class="navbar navbar-default ">
            ...
            <div class="number navbar-brand hidden-sm hidden-xs">+7 (495) 032-29-29</div>
            <div class="number navbar-brand hidden-sm hidden-xs">
              <a href="mailto:admin@olaplex-shop.ru">admin@olaplex-shop.ru</a>
              <br />
              <a href="mailto:client@olaplex-shop.ru">client@olaplex-shop.ru</a>
            </div>
          </nav>
        </div>
      </div>
